SELECT
    ...
    'final' AS status,
    -- 'http://terminology.hl7.org/CodeSystem/observation-category' AS "category.coding.system",
    -- 'laboratory' AS "category.coding.code",
    -- 'Laboratory' AS "category.coding.display",
